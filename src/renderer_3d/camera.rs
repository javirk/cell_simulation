...
impl CameraUniform {
    ...
    pub fn update_position(&mut self, camera: &Camera) {
        self.eye = camera.eye.into();
    }

    pub fn update_target(&mut self, camera: &Camera) {
        self.target = camera.target.into();
    }
}
...
impl CameraController {
    ...
    pub fn update_camera(&self, camera: &mut Camera) {
        ...
        if self.is_left_pressed {
            ...
            // WARNING: Pressing left means moving the eye to the right.
        ...
        // WARNING: Pressing up means moving the eye down.
